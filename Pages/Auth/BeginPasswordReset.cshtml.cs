...
{
    public class BeginPasswordResetModel : PageModel
    {
        ...
        protected string GeneratePwToken(string userID)
        {
            ...
            try
            {
                string sql = "UPDATE User SET ResetPwToken = @PWTOKEN, ResetPwTokenExpiry = @PWTOKENEXPIRY WHERE Email=@USERID; ";
                using (var cmd = new MySqlCommand(sql, con))
                {
                    cmd.Parameters.AddWithValue("@USERID", emailAddress);
        ...
        public IActionResult OnPost()
        {
            ...
            string mailbody = "<h1>Forgot your password?</h1><br> You requested a link to change your password. (If you didn't request this, you can ignore this email.)<br>reset your password by clicking on the link below <br>" + "https://localhost:44320/Auth/EndPasswordReset?token=" + HttpUtility.UrlEncode(GeneratePwToken(emailAddress));
            ...
            {
                Response.Redirect("/Auth/BeginPasswordConfirm", false);
            }
